...
class UserServiceTest {
    ...
    void updateUserOverwritesNameAndEmail() {
        ...
        UserUpdateRequestBody request = updateRequest("New Name", "new@example.invalid", null, null);
    ...
    void updateUserRejectsEmailAlreadyInUse() {
        ...
        UserUpdateRequestBody request = updateRequest("New Name", "taken@example.invalid", null, null);
    ...
    void updateUserSkipsUniquenessLookupWhenEmailUnchanged() {
        ...
        userService.updateUser(USER_ID, updateRequest("New Name", EMAIL, null, null));
    ...
    void updateUserEncodesSuppliedPassword() {
        ...
        UserUpdateRequestBody request = updateRequest("Original Name", EMAIL, "new-plain-password", null);
    ...
    void updateUserKeepsHashWhenPasswordIsNull() {
        ...
        userService.updateUser(USER_ID, updateRequest("Original Name", EMAIL, null, null));
    ...
    void updateUserKeepsHashWhenPasswordIsBlank() {
        ...
        userService.updateUser(USER_ID, updateRequest("Original Name", EMAIL, "", null));
    ...
    void updateUserReplacesAvatarWhenSupplied() {
        ...
        UserUpdateRequestBody request = updateRequest(
    ...
    void updateUserKeepsAvatarWhenAbsent() {
        ...
        UserResponseBody result = userService.updateUser(
                USER_ID, updateRequest("Original Name", EMAIL, null, null));
    ...
    void updateUserThrowsWhenUserMissing() {
        ...
        assertThatThrownBy(() -> userService.updateUser(
                USER_ID, updateRequest("New Name", EMAIL, null, null)))
                .isInstanceOf(IllegalArgumentException.class);
